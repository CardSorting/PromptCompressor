...
export class BroccoliBatchCoalescer {
    ...
    constructor() {
        this.batchTable = new BroccoliDbTable('batch_coalesce_queue');
     ...
     */
    static async executeSingleFlight(queryText, model, fetcher) {
    ...
    static flushBatch() {
        ...
        for (const item of queued) {
            ...
            const updated = { ...item, status: 'DISPATCHED' };
...
//# sourceMappingURL=BroccoliBatchCoalescer.js.map