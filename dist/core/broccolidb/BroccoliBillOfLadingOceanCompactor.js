...
export class BroccoliBillOfLadingOceanCompactor {
    ...
    static compactOceanBl(rawText) {
        ...
        if (carrier.length > 80)
            carrier = carrier.substring(0, 77) + '...';
        ...
        if (shipper.length > 80)
            shipper = shipper.substring(0, 77) + '...';
        if (consignee.length > 80)
            consignee = consignee.substring(0, 77) + '...';
...
//# sourceMappingURL=BroccoliBillOfLadingOceanCompactor.js.map