...
export class BroccoliBpeBytePairTokenDedupBuffer {
    static instance;
    bpeMerges = new Map(); // pair -> mergedToken
    bpeAuditTable;
    constructor() {
     ...
     */
    static decompressBpe(compactedText) {
        const buffer = this.getInstance();
...
//# sourceMappingURL=BroccoliBpeBytePairTokenDedupBuffer.js.map