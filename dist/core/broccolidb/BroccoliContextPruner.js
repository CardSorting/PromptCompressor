...
export class BroccoliContextPruner {
     ...
     */
    static pruneRagContext(userQuery, chunks, options = {}) {
        ...
        const queryKeywords = new Set(userQuery
            .toLowerCase()
            .replace(/[^a-z0-9\s]/g, ' ')
            .split(/\s+/)
            .filter((w) => w.length > 3));
...
//# sourceMappingURL=BroccoliContextPruner.js.map