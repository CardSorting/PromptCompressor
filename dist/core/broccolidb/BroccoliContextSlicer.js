...
export class BroccoliContextSlicer {
     ...
     */
    static parseSections(documentText) {
     ...
     */
    static sliceDocumentForQuery(documentText, userQuery) {
...
//# sourceMappingURL=BroccoliContextSlicer.js.map