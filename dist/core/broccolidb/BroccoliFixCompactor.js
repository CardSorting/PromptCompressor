...
export class BroccoliFixCompactor {
    ...
    static compactFix(rawFixText) {
        ...
        if (raw35 === 'D')
            msgType = 'NEW ORDER SINGLE (35=D)';
        else if (raw35 === '8')
            msgType = 'EXECUTION REPORT (35=8)';
        else if (raw35 === 'F')
            msgType = 'ORDER CANCEL REQUEST (35=F)';
        else if (raw35 === 'G')
            msgType = 'ORDER CANCEL/REPLACE (35=G)';
        ...
        if (statusVal === '2')
            execStatus = 'STATUS: FILLED (100% matched)';
        else if (statusVal === '1')
            execStatus = 'STATUS: PARTIALLY FILLED';
        else if (statusVal === '4')
            execStatus = 'STATUS: CANCELED';
        else if (statusVal === '8')
...
//# sourceMappingURL=BroccoliFixCompactor.js.map