...
export class BroccoliKVCacheOptimizer {
     ...
     */
    static optimizePrompt(messages, inputPricePer1M = 2.50 // Sol retail input price $2.50/1M ($1.25 cached)
    ) {
        ...
        for (const msg of messages) {
            if (msg.role === 'system') {
                ...
                for (const line of lines) {
                    ...
                    if (/timestamp|current_time|date|request_id|nonce|session_id|uuid/i.test(line) &&
                        line.length < 200) {
...
//# sourceMappingURL=BroccoliKVCacheOptimizer.js.map