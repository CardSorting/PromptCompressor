...
export class BroccoliLostInMiddlePruner {
    static instance;
    prunerAuditTable;
    static RELEVANCE_CUTOFF_THRESHOLD = 0.55;
    constructor() {
     ...
     */
    static optimizeContextChunks(chunks, maxChunksRetained = 6, inputPricePer1M = 2.50 // Sol input rate
    ) {
        ...
        const uShapedArray = new Array(qualifiedChunks.length);
        let left = 0;
...
//# sourceMappingURL=BroccoliLostInMiddlePruner.js.map