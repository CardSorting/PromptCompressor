...
export class BroccoliMatryoshkaCompactor {
     ...
     */
    static truncateVector(denseVector, targetDimensions = 512) {
        ...
        const compactedVector = new Array(targetDimensions);
        for (let i = 0; i < targetDimensions; i++) {
        ...
        const memoryReductionPercentage = Number((((originalDimensions - targetDimensions) / originalDimensions) * 100).toFixed(1));
...
//# sourceMappingURL=BroccoliMatryoshkaCompactor.js.map