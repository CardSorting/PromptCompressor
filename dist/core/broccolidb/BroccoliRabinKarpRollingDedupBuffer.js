...
export class BroccoliRabinKarpRollingDedupBuffer {
    static instance;
    chunkRegistry = new Map();
    windowSize;
    mask; // e.g. 0x0FFF for ~4KB average chunks
    totalChunksProcessed = 0;
    totalDuplicateChunks = 0;
    rkAuditTable;
    constructor(windowSize = 32, mask = 0x0FFF) {
        this.windowSize = windowSize;
        this.mask = mask;
        this.rkAuditTable = new BroccoliDbTable('rabin_karp_cdc_audit');
        this.rkAuditTable.createIndex('duplicateChunks');
    }
    static getInstance(windowSize = 32, mask = 0x0FFF) {
...
//# sourceMappingURL=BroccoliRabinKarpRollingDedupBuffer.js.map