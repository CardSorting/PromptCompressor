...
export class BroccoliRoaringBitmapPostingBuffer {
    static instance;
    arrayContainers = new Map(); // highKey -> array of lowInts
    bitsetContainers = new Map(); // highKey -> 2048 x 32-bit words (65536 bits)
    totalDocCount = 0;
    roaringAuditTable;
    constructor() {
...
//# sourceMappingURL=BroccoliRoaringBitmapPostingBuffer.js.map