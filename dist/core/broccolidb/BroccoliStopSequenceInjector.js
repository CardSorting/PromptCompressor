...
export class BroccoliStopSequenceInjector {
     ...
     */
    static injectStopSequences(promptText, existingStopSequences) {
        ...
        let detectedPattern = 'STANDARD_DIALOG';
        const recommendedStops = new Set(existingList);
...
//# sourceMappingURL=BroccoliStopSequenceInjector.js.map