...
export class BroccoliSwiftMt103Compactor {
    ...
    static compactMt103(rawText) {
        ...
        if (ordering.length > 80)
            ordering = ordering.substring(0, 77) + '...';
        if (beneficiary.length > 80)
            beneficiary = beneficiary.substring(0, 77) + '...';
...
//# sourceMappingURL=BroccoliSwiftMt103Compactor.js.map