...
export class BroccoliTestOutputCompactor {
     ...
     */
    static compactTestLog(rawTestOutput) {
        ...
        const outputLines = [];
        outputLines.push(`[PASSING TEST SUITES (${passingSuites.length} passed): Omitted for token compaction]`);
...
//# sourceMappingURL=BroccoliTestOutputCompactor.js.map