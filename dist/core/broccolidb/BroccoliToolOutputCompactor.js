...
export class BroccoliToolOutputCompactor {
     ...
     */
    static compactToolOutput(rawOutput, maxArrayElements = 5, inputPricePer1M = 2.50 // Sol input price
    ) {
        ...
        if (typeof rawOutput === 'object' && rawOutput !== null) {
            if (Array.isArray(rawOutput)) {
                ...
                for (const [key, value] of Object.entries(rawOutput)) {
                    if (value === null || value === undefined || value === '')
                        continue;
                    if (/^(pagination|meta|links|trace_metadata|request_id|_links)$/i.test(key))
                        continue;
            ...
            const filteredLines = lines.filter((line) => {
                ...
                if (/^(npm warn|downloading|progress|fetch|extracting|\.{3,})/i.test(trimmed))
                    return false;
                return true;
            });
...
//# sourceMappingURL=BroccoliToolOutputCompactor.js.map