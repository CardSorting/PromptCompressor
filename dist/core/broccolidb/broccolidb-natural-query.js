...
export class BroccoliNaturalQueryParser {
     ...
     */
    static parse(rawText, defaultTable = "default") {
        ...
        while ((cMatch = compRegex.exec(text)) !== null) {
            ...
            const existingFilter = (typeof where[field] === "object" && where[field] !== null)
                ? where[field]
                : {};
            let updatedFilter;
            switch (op) {
                case ">=":
                    updatedFilter = { ...existingFilter, $gte: val };
                    break;
                case "<=":
                    updatedFilter = { ...existingFilter, $lte: val };
                    break;
                case ">":
                    updatedFilter = { ...existingFilter, $gt: val };
                    break;
                case "<":
                    updatedFilter = { ...existingFilter, $lt: val };
                    break;
                case "!=":
...
//# sourceMappingURL=broccolidb-natural-query.js.map