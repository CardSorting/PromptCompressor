...
export class TierCascadingEvalHarness {
     ...
     */
    static evaluateWorkload(workload, samples, baselineModel = 'gpt-5.6-sol', candidateModel = 'gpt-5.6-luna') {
        ...
        const standardError = Math.sqrt((baselineAccuracy * (1 - baselineAccuracy) + candidateAccuracy * (1 - candidateAccuracy)) / sampleCount);
     ...
     */
    static generateAttestationReport(result) {
        return `=====================================================================
...
=====================================================================`;
    ...
    static scoreSample(sample, _model) {
...
//# sourceMappingURL=TierCascadingEvalHarness.js.map