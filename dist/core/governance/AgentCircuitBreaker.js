...
export class AgentCircuitBreaker {
     ...
     */
    static evaluateSession(sessionId, messages, maxTurnsAllowed = 12) {
        if (!sessionId) {
        ...
        if (messages.length > 0) {
            ...
            if (state.lastTurnHashes.length > 6)
                state.lastTurnHashes.shift();
            if (duplicateCount >= 3) {
                state.isTripped = true;
...
//# sourceMappingURL=AgentCircuitBreaker.js.map