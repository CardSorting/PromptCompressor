...
export class OutputVerbosityOptimizer {
    static CONCISE_DIRECTIVE = 'Concise response mode: Output only the required answer or JSON object directly. Omit conversational filler, polite pleasantries, and preamble introductory phrases.';
    /**
     * Evaluates if a request should have concise output directives attached
     */
    static optimizeRequest(messages, options = {}) {
...
//# sourceMappingURL=OutputVerbosityOptimizer.js.map