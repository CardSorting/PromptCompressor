...
- [`LICENSING.md`](LICENSING.md) explains the Apache-2.0 scope, attribution, and third-party boundary.
...
- [`../LICENSE`](../LICENSE) is the complete Apache License, Version 2.0 text for this distribution.
- [`../NOTICE`](../NOTICE) records project attribution and extraction provenance.
- [`../SECURITY.md`](../SECURITY.md) defines responsible reporting and sensitive-data handling.
- [`../CHANGELOG.md`](../CHANGELOG.md) records package-level changes.
...
`docs:check` verifies required guides, knowledge-base links, ADR structure, license/notice presence, package metadata, and local Markdown targets. It does not prove compaction fidelity, provider billing, or legal rights for separately licensed material; those require the code tests, host integration checks, and provenance review described in the other guides.
...
4. Update `LICENSE`, `NOTICE`, `docs/LICENSING.md`, and `package.json` together when the licensing boundary changes.
5. Run the code and documentation gates, then inspect `npm pack --dry-run`.
