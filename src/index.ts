...
// Gateway contracts needed by spend-governance callers. ChatMessage is aliased
// because BroccoliDB also has a history-specific ChatMessage type.
export type {
  ChatCompletionRequest,
  ChatMessage as GatewayChatMessage,
  ModelSpecItem as GatewayModelSpecItem,
  ProviderType as GatewayProviderType,
} from './core/contracts/GalxContracts.js';
